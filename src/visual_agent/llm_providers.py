...
OPENAI_COMPATIBLE_PROVIDERS = {"openai", "xiaomimimo", "qwen", "kimi", "deepseek", "volcengine"}
...
def run_llm_completion(
    *,
    ...
    payload = _completion_request_payload(provider, backend.model_id, system_prompt, prompt, max_tokens)
