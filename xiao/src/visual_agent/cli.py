...
def build_parser(prog: str = DEFAULT_CLI_NAME) -> argparse.ArgumentParser:
    ...
    chief_dispatch.add_argument("--no-dep-bootstrap", action="store_true", help="Do not install dependencies inside the isolation worktree before verification (faster, but a project whose deps are gitignored will fail its own test command there).")
    chief_dispatch.add_argument("--no-base-probe", action="store_true", help="Skip the base-commit probe that checks whether the acceptance command actually tests this task (faster, but the result can only be reported as regression_clear).")
    ...
    chief_run.add_argument("--no-dep-bootstrap", action="store_true", help="Do not install dependencies inside the isolation worktree before verification (faster, but a project whose deps are gitignored will fail its own test command there).")
    chief_run.add_argument("--no-base-probe", action="store_true", help="Skip the base-commit probe that checks whether the acceptance command actually tests this task (faster, but the result can only be reported as regression_clear).")
    ...
    mission.add_argument("--no-dep-bootstrap", action="store_true", help="Do not install dependencies inside the isolation worktree before verification (faster, but a project whose deps are gitignored will fail its own test command there).")
    mission.add_argument("--no-base-probe", action="store_true", help="Skip the base-commit probe that checks whether the acceptance command actually tests this task (faster, but the result can only be reported as regression_clear).")
